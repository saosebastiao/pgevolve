...
proptest! {
    ...
    fn plpgsql_canonicalization_is_idempotent(
        ...
        let r1 = parse_routine_body(body, FunctionLanguage::PlPgSql, RoutineResult::Void, &qname, &loc);
        ...
        let r2 = parse_routine_body(body1.canonical_text(), FunctionLanguage::PlPgSql, RoutineResult::Void, &qname, &loc);
